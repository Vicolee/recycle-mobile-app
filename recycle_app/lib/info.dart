  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
          ...
          child: Text(
            'As long as they’re clean and dry, plastic bottles and containers,'
            ' paper, flattened cardboard, food and beverage cans and '
            'containers, and glass bottles and containers can be recycled.'
            '\n\nThere are three main categories for discarding waste. If '
            'something is non-recyclable, it belongs to the general waste '
            'bins. Some goods can be recycled through the general blue '
            'recycling bins, and some need to be brought to special '
            ' facilities to be repurposed. In general, if an item is plastic,'
            ...
            ' out of it-- no liquids can be present either. You cannot '
            'recycle plastic bags: this means that you also cannot place all '
            'your recyclable items into a plastic bag and then into the '
            'recycling bin.\n\nWhen recycling anything, it’s important to '
            'double check to make sure that your specific community accepts '
            'the material you are trying to recycle.',
            style: TextStyle(
