...
When contributing a major change to this repository, please first discuss the change you wish to make via an issue request. Minor issues can simply be addressed by sending by a pull request.
